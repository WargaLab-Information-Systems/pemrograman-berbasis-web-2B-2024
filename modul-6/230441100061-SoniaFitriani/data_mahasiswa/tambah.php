...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    mysqli_query($koneksi, "INSERT INTO dtmaha (Nama, NIM, Umur, Jenis_kelamin, Prodi, Jurusan, Asal_kota) VALUES('$nama', '$nim', '$umur', '$jenis_kelamin', '$prodi', '$jurusan', '$asal_kota')");
